                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="glass-card p-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <StatusProgress label="รออนุมัติ" count={stats?.pending} total={stats?.total} color="bg-amber-500" />
                            <StatusProgress label="รอตรวจสอบ" count={stats?.checking} total={stats?.total} color="bg-blue-500" />
                            <StatusProgress label="อื่นๆ" count={stats?.total - (stats?.invoiced + stats?.pending + stats?.checking)} total={stats?.total} color="bg-slate-300" />
                        </div>
